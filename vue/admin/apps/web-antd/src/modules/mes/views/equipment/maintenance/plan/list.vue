...
import { deleteMaintenancePlan, getMaintenancePlanPage } from '#/modules/mes/api/maintenance';
...
<template>
  <Page auto-content-height>
    ...
    <Grid :table-title="$t('mes.equipment.maintenancePlan.list')">
      <template #toolbar-tools>
        <Button type="primary" @click="onCreate">
          <Plus class="size-5" />
          {{ $t('ui.actionTitle.create', [$t('mes.equipment.maintenancePlan.name')]) }}
        </Button>
      </template>
    </Grid>
  </Page>
