  ...
  return [
    {
      ...
      label: $t('mes.basadata.line.workshopId'),
      rules: 'required',
    ...
    },
    {
      ...
      fieldName: 'code',
      label: $t('mes.basadata.line.code'),
      rules: 'required',
    ...
    },
    {
      ...
      componentProps: { class: 'w-full' },
      fieldName: 'name',
      label: $t('mes.basadata.line.name'),
      rules: 'required',
      formItemClass: 'md:col-span-1 col-span-2',
    },
    {
      ...
      fieldName: 'status',
      label: $t('mes.basadata.line.status'),
      defaultValue: 1,
      formItemClass: 'col-span-2',
    },
  ];
...
export function useColumns(
  ...
  return [
    { field: 'code', title: $t('mes.basadata.line.code') },
    { field: 'name', title: $t('mes.basadata.line.name') },
    { field: 'workshopName', title: $t('mes.basadata.line.workshopId') },
    {
      cellRender: { name: 'CellTag', attrs: { options: { 0: '禁用', 1: '启用' } } },
      field: 'status',
      title: $t('mes.basadata.line.status'),
    },
    {
      align: 'center',
      cellRender: {
      ...
      headerAlign: 'center',
      showOverflow: false,
      title: $t('mes.basadata.line.operation'),
      width: 180,
    },
  ];
}
