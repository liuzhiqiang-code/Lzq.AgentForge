...
import { createMaintenanceRecord } from '#/modules/mes/api/maintenance';
...
const getTitle = computed(() => {
  return formData.value?.id
    ? $t('ui.actionTitle.edit', [$t('mes.equipment.maintenanceRecord.name')])
    : $t('ui.actionTitle.create', [$t('mes.equipment.maintenanceRecord.name')]);
});
