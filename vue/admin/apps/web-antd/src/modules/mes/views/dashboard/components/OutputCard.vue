...
import { getProductionOutput } from '#/modules/mes/api';
  ...
  <Card class="shadow-sm" :loading="loading">
    <template #title>
      <div class="flex items-center">
        ...
        {{ $t('mes.dashboard.productionOutput') }}
      </div>
    </template>
    <Statistic :value="todayOutput" :title="$t('mes.dashboard.todayOutput')" />
    <Statistic :value="weekOutput" :title="$t('mes.dashboard.weekOutput')" class="mt-2" />
  </Card>
</template>
