...
namespace Lzq.WorkOrder.Application.Services.ReferenceData;
...
{
    public ReferenceDataService(ILineRepository lineRepo, IProcessRepository processRepo)
    {
        LineRepo = lineRepo;
        ProcessRepo = processRepo;
    }

    private ILineRepository LineRepo { get; }
    private IProcessRepository ProcessRepo { get; }
