...
public class DefectRecordServiceTests : ServiceTestBase
{
    ...
    public async Task PageAsync_ShouldReturnPagedDefects()
    {
        ...
        var result = await DefectRecordService.PageAsync(query);
    ...
    public async Task GetAsync_ShouldReturnDefect()
    {
        ...
        var result = await DefectRecordService.GetAsync(defect.Id);
    ...
    {
        var act = () => DefectRecordService.GetAsync(99999);
    ...
    public async Task CreateAsync_ShouldCreateDefect()
    {
        ...
        var result = await DefectRecordService.CreateAsync(command);

        result.IsSuccess.Should().BeTrue();
        var defects = await AllDefectRecordsAsync();
    ...
    public async Task DeleteAsync_ShouldDeletePendingDefect()
    {
        ...
        var result = await DefectRecordService.DeleteAsync(defect.Id);
    ...
    public async Task DeleteAsync_ProcessedDefect_ShouldThrow()
    {
        ...
        var act = () => DefectRecordService.DeleteAsync(defect.Id);
    ...
    {
        var act = () => DefectRecordService.DeleteAsync(99999);
    ...
    public async Task HandleAsync_ShouldHandlePendingDefect()
    {
        ...
        var result = await DefectRecordService.HandleAsync(command);
    ...
    public async Task HandleAsync_AlreadyProcessed_ShouldThrow()
    {
        ...
        var act = () => DefectRecordService.HandleAsync(command);
    ...
    public async Task ReviewAsync_ShouldReviewDefect()
    {
        ...
        var result = await DefectRecordService.ReviewAsync(command);
    ...
    public async Task ReviewAsync_NotNeedReview_ShouldThrow()
    {
        ...
        var act = () => DefectRecordService.ReviewAsync(command);
